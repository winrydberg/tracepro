<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
    <div class="main-menu-content">
      <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
        ...
        <li class=" nav-item"><a href="{{url('/distributor/receive-inputs')}}"><i class="ft-menu"></i><span data-i18n="" class="menu-title">NEW ORDER</span></a>
        </li>
        <li class=" nav-item"><a href="{{url('/distributor/receive-inputs')}}"><i class="ft-menu"></i><span data-i18n="" class="menu-title">RE-CALL</span></a>
        </li>
      {{-- <li class=" nav-item"><a href="{{url('/admin/dashboard')}}"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
        ...
        <li class=" nav-item"><a href="#" onclick="openCustomRoxy2('')"><i class="ft-server"></i><span data-i18n="" class="menu-title">File Manager</span></a>
          ...
          {{-- <li class=" nav-item"><a href="#"><i class="ft-users"></i><span data-i18n="" class="menu-title">DISTRIBUTOR</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
