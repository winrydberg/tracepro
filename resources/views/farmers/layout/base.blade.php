...
height: auto;       
  ...
  @includeWhen(true,'farmers.layout.topnav') 
  @includeWhen(true,'farmers.layout.sidemenu')
   ...
   <script src="{{asset('assets/js/core/jquery/jquery.min.js')}}" type="text/javascript"></script>
    ...
    <script src="{{asset('assets/js/core/datatables.min.js')}}" type="text/javascript"></script>
    @yield('scripts-below')
