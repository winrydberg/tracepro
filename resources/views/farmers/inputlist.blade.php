    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">INPUT LIST</h4>
                        ...
                        <tbody>
                          @foreach($farminputs as $f)
                            <tr>
                                ...
                                <td>{{$f->receiptno}}</td>
                                <td>
                                <a href="{{url('/farmers/action/'.$f->id.'/view')}}" class="btn btn-sm btn-primary">View</a>
                                  <a href="{{url('/farmers/action/'.$f->id.'/update')}}" class="btn btn-sm btn-success">Edit</a>
