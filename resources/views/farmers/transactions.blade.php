                        ...
                        <div class="card-body">
                            ...
                            <form class="form" id="transactionform">
                                ...
                                <div class="form-body">
                                    ...
                                    <h4 class="form-section"> Product Input Information</h4>
                                    <div class="row">
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                            <label for="supplierofproductinput">Did you use any Supplier input? if yes. The Supplier Bin</label>
                                                            <input type="text" id="supplierofproductinput" class="form-control" name="supplierofproductinput">
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                            <label for="batchnoofsupplierproduct">Batch Number of Supplier input</label>
                                                            <input type="text" id="batchnoofsupplierproduct" class="form-control" name="batchnoofsupplierproduct">
                                                    </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-actions center">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-check-square-o"></i> Save <img src="{{asset('assets/images/loading.gif')}}" id="loadinggif" style="max-height: 25px;display: none">
                                    </button>
                                </div>
                            </form>
                        </div>
