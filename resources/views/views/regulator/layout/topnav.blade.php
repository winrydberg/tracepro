        ...
        <div class="navbar-header" style="background: #16000D">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item mr-auto"><a href="#" class="navbar-brand">
                ...
                <h2 class="brand-text">TRACEPRO</h2>
        ...
        <div class="navbar-container content">
          <div id="navbar-mobile" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon ft-bell"></i><span class="badge badge-pill badge-default badge-danger badge-default badge-up">1</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  @if(Auth::guard('regulator')->check())
            <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="{{asset('assets/images/profile.png')}}" alt="avatar"><i></i></span><span class="user-name">{{Auth::guard('regulator')->user()->email}}</span></a>
                        <div class="dropdown-menu dropdown-menu-right">
                          <div class="dropdown-divide"></div><a href="{{url('regulator/logout')}}" class="dropdown-item"><i class="ft-power"></i> Logout</a>
                        </div>
                    </li>
                  @endif
            </ul>
